...
void Sprite::Blit(void)
{
	...
	//send the scaling
	prog->setUniform("in_Scale", scale);
...
void Sprite::Blit(float scale_val)
{
	scale = scale_val;
	Blit();
}

void Sprite::Blit(float x, float y, float scale_val)
{
	scale = scale_val;
	dest_x = x;
	dest_y = y;
...
void Sprite::Blit(float x, float y, float scale_val, float alpha_val)
{
	scale = scale_val;
	alpha = alpha_val;
	dest_x = x;
